                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="produto-form-qtd-loja" name="qtdLoja" value="<?= htmlspecialchars((string) ($produto['qtdLoja'] ?? '')) ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label" for="produto-form-qtd-estoque">Quantidade em Estoque</label>
                                <input type="number" class="form-control" id="produto-form-qtd-estoque" name="qtdEstoque" value="<?= htmlspecialchars((string) ($produto['qtdEstoque'] ?? '')) ?>">
                            </div>
                        </div>
                    </div>
