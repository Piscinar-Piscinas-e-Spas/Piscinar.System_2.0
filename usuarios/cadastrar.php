...
if (($_SERVER['REQUEST_METHOD'] ?? '') === 'POST') {
    ...
    if ($usuario === '' || $senha === '') {
        $alert = [
            'type' => 'danger',
            'message' => 'Informe o usuário e a senha para concluir o cadastro.',
        ];
    } elseif (mb_strlen($usuario) > 80) {
        $alert = [
            'type' => 'danger',
            'message' => 'O usuário deve ter no máximo 80 caracteres.',
        ];
    } elseif ($nomeExibicao !== '' && mb_strlen($nomeExibicao) > 120) {
        $alert = [
            'type' => 'danger',
            'message' => 'O nome de exibição deve ter no máximo 120 caracteres.',
        ];
...
<div class="card">
    <div class="card-header">
        <h4><i class="fas fa-user-plus me-2"></i>Cadastrar Usuário</h4>
    </div>
    <div class="card-body">
        ...
        <form method="POST" novalidate>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label" for="nome_exibicao">Nome de exibição (opcional)</label>
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <a href="<?= app_url('index.php'); ?>" class="btn btn-secondary me-md-2">
